...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 bg-[#020203] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(circle_at_top_right,rgba(255,107,0,0.08),transparent_40%)]" />
          ...
          <div className="flex flex-col">
            ...
            <div className="grid gap-8">
               {[
                 ...
                 >
                    <div className="w-14 h-14 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-center text-orange-500 group-hover:bg-orange-500 group-hover:text-white transition-all duration-500 shadow-xl">
                       <item.icon size={22} />
                    </div>
                    <div>
                       <p className="text-[9px] text-gray-600 uppercase font-black tracking-[0.3em] mb-1">{item.label}</p>
                       <span className="text-white font-black text-sm tracking-tight group-hover:text-orange-500 transition-colors uppercase leading-none">{item.text}</span>
                    </div>
                 </motion.div>
               ))}
            </div>
